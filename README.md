...
## Файл содержит:
* Домашнее задание 1 (выполнено cо схемами) со строки 10 (проверено)
* Домашнее задание 2 (выполнено со схемами) со строки 66 (проверено)
* Домашнее задание 3 (вывополнено без схем) со строки 112 (проверено)
* Домашнее задание 4 (начато)
