...
## Файл содержит:
* Домашнее задание 1 (выполнено cо схемами) со строки 12 (проверено)
* Домашнее задание 2 (выполнено со схемами) со строки 68 (проверено)
* Домашнее задание 3 (выполнено без схем) со строки 114 (проверено)
* Домашнее задание 4 (выполнено без схем) со строки 150 (проверено)
* Домашнее задание 5 (выполнено без схем) со строки 184 ()
